      ...
      {/* {widgetList  ? ( */}
        <>
          <Checkbox
            ...
            checked={
              widgetList.filter((item) => item == "1") == "1" ? true : false
            }
          />
          <Checkbox
            color="primary"
            ...
            onChange={handleCheckboxChange}
            checked={
              widgetList.filter((item) => item == "2") == "2" ? true : false
            }
          />
          <Checkbox
            color="primary"
            ...
            onChange={handleCheckboxChange}
            checked={
              widgetList.filter((item) => item == "3") == "3" ? true : false
            }
          />
          <Checkbox
            color="primary"
            ...
            onChange={handleCheckboxChange}
            checked={
              widgetList.filter((item) => item == "4") == "4" ? true : false
            }
          />
          <Checkbox
            color="primary"
            ...
            onChange={handleCheckboxChange}
            checked={
              widgetList.filter((item) => item == "5") == "5" ? true : false
            }
          />
          <Checkbox
            color="primary"
            ...
            onChange={handleCheckboxChange}
            checked={
              widgetList.filter((item) => item == "6") == "6" ? true : false
            }
          />
          <Checkbox
            color="primary"
            ...
            onChange={handleCheckboxChange}
            checked={
              widgetList.filter((item) => item == "7") == "7" ? true : false
            }
          />
          <Checkbox
            color="primary"
            ...
            onChange={handleCheckboxChange}
            checked={
              widgetList.filter((item) => item == "8") == "8" ? true : false
            }
          />
          <Checkbox
            color="primary"
            ...
            onChange={handleCheckboxChange}
            checked={
              widgetList.filter((item) => item == "9") == "9" ? true : false
            }
          />
          <Checkbox
            color="primary"
